  ...
  return (
    <div className="relative min-h-screen w-full overflow-hidden">
      <div
        ...
        style={{
          backgroundImage:
            "linear-gradient(rgba(0,0,0,0.6), rgba(0,0,0,0.6)), url('https://images.unsplash.com/photo-1614164185128-e4ec99c436d7?q=80&w=1974')",
        }}
      >
      ...
      <div className="relative z-20 flex justify-center items-center h-screen px-6 page-transition">
        <form
          ...
          className="bg-white/5 backdrop-blur-xl p-10 md:p-12 rounded-3xl border border-white/10 w-full max-w-md shadow-2xl"
        >
          <div className="text-center mb-10">
            <h1 className="text-4xl font-extrabold text-gold tracking-tighter mb-2">
              Welcome Back
            </h1>
            <p className="text-gray-300 text-sm">
              Sign in to access your luxury timepieces.
            </p>
          </div>
          ...
          <button
            type="submit"
            className="w-full bg-gold text-black font-bold py-4 rounded-xl mt-10 hover:bg-white transition duration-300 shadow-lg"
          >
            LOG IN
          </button>
          ...
          <div className="text-center mt-8 text-sm text-gray-400">
            ...
            <Link
              to="/register"
              className="text-gold font-medium hover:text-white transition"
            >
              Create an Account
            </Link>
          </div>
