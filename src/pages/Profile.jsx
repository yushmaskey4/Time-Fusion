        ...
        <div className="bg-gray-900 p-8 rounded-xl border border-gray-800">
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                type="text"
                defaultValue="Balen Sampang Oli"
                className="w-full bg-black p-3 rounded border border-gray-800"
              />
            </div>
            <div>
            ...
            <button className="w-full bg-gold text-black font-bold py-3 rounded mt-4">
              UPDATE PROFILE
            </button>
          </div>
        </div>
        ...
        <div className="bg-gray-900 p-8 rounded-xl border border-gray-800">
          ...
          <div className="space-y-4">
            <div className="border-b border-gray-800 pb-2">
              ...
              <span className="text-[10px] bg-green-900 text-green-300 px-2 rounded">
                Completed
              </span>
            </div>
            <div className="border-b border-gray-800 pb-2">
              ...
              <span className="text-[10px] bg-yellow-900 text-yellow-300 px-2 rounded">
                Pending
              </span>
            </div>
          </div>
